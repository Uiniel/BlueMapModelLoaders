...
public class CompositeModelRenderer implements BlockRenderer {
    public static final BlockRendererType INSTANCE = new BlockRendererType.Impl(new Key("bluemapmodelloaders",  "composite"), CompositeModelRenderer::new);
